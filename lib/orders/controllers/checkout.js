                          ...
                          function(done){
                            Delivery.findOne({
                              ...
                              if (err) done(err);
                                ...
                                from = new Date(from.getTime() + 60 * 60 * 24 * 7 * 1000);
                                to = new Date(to.getTime() + 60 * 60 * 24 * 7 * 1000);
...
exports.sendNotifications = function (order) {
  ...
  var now = new Date();
  var weekend_start = now.getDay() < 5 ? new Date(now.getTime() + ( (5 - now.getDay()) * (1000 * 60 * 60 * 24))) : new Date(now.getTime() + ( (12 - now.getDay()) * (1000 * 60 * 60 * 24)));
  var weekend_end = now.getDay() < 5 ? new Date(now.getTime() + ( (7 - now.getDay()) * (1000 * 60 * 60 * 24))) : new Date(now.getTime() + ( (14 - now.getDay()) * (1000 * 60 * 60 * 24)));
